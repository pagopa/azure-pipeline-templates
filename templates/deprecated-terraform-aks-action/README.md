# Terraform plan with AKS

Run terraform init and terraform plan for those projects with AKS.

Is possible to do the plan for AKS resources, to do that we use a Service Account with CA CRT and token that is used to generate the kubeconfig for terraform
